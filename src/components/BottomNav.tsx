...
export default function BottomNav() {
  ...
  return (
    <div className="fixed bottom-6 left-0 right-0 flex justify-center z-50 pointer-events-none">
      <nav className="background-white/80 backdrop-blur-lg  pointer-events-auto h-16 px-6 rounded-full flex items-center gap-8 shadow-2xl border border-white/20 dark:border-white/10">
